                                    ...
                                    <div class="card-body">
                                        <form action="proses_reservasi.php?aksi=tambah" method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" type="text" name="nama" id="nama" placeholder="masukkan nama pelanggan"  required>
                                                <label for="inputname">Nama Pelanggan</label>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input class="form-control" type="text" name="alamat" id="alamat" placeholder="masukkan nama pelanggan"  required>
                                                <label for="inputname">Alamat</label>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input class="form-control" type="number" name="no_hp" id="no_hp" placeholder="masukkan nama pelanggan"  required>
