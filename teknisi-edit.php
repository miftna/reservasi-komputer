...
<div class="container-fluid pt-4 px-4">
    <h1 class="mt-4">Dashboard</h1>
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item"><a href="teknisi-data.php">Data Teknisi</a></li>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="jenis_kelamin" class="form-check-inline">Jenis kelamin</label>
                                ...
                                <div class="form-check form-check-inline">  
                                    <input type="radio" name="Jenis_kelamin" value="<?php echo $data['Jenis_kelamin']; ?>" class="form-check-input">
                        ...
                        <div class="mb-3">
                            <label for="spesialis" class="form-label">
                                <i><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16"><path fill="currentColor" d="M4.1 8c.2.6.3 1.1.3 1.1c.8 1.3 1.8 1.1 1.8 1.8c0 .3-.2.6-.5.7L8 13.4l2.3-1.7c-.3-.2-.5-.4-.5-.7c0-.8 1-.5 1.8-1.8c0 0 .2-.4.3-1.1c.3-1.1.6-3.1.5-4.1h-1.5c0-.3.1-.6.1-1h1.1c-.3-1.4-1-2-2.2-2.3C9.4.3 8.7 0 8 0S6.6.3 6.1.7C4.9 1 4.3 1.6 3.9 3H5c0 .4.1.7.2 1H3.6c-.1 1 .2 3 .5 4m7.1.5l-.3.3l-.5.6c-.4.5-.8.8-1.4.9l-.4.1c-.4.1-.9.1-1.4 0l-.4-.1c-.6-.2-1.1-.5-1.5-1.1l-.2-.4l-.3-.3l-.7-.5l3.1-.9c.5-.1 1-.2 1.5 0l3.2.9zM6 3c0-1.1.9-2 2-2s2 .9 2 2s-.9 2-2 2s-2-.9-2-2"/><path fill="currentColor" d="M15.5 14.2c-1.3-2.4-2.6-2-3.9-2.2h-.1L8 14.6L4.5 12h-.1c-1.4.1-2.6-.2-3.9 2.2c-.2.4-.4 1.1-.5 1.8h16c-.1-.7-.3-1.4-.5-1.8"/></svg></i>
                            Spesialis
                            </label>
